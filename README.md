...
currently   : Building → CoWork Platform | Learning → Jenkins & CI/CD
...
### CoWork Platform
`React` `TypeScript` `Node.js` `Express` `MongoDB` &nbsp;·&nbsp; *Jan 2026*
...
`AWS EKS` `Terraform` `ArgoCD` `Trivy` `Sealed Secrets` &nbsp;·&nbsp; *Apr 2026*
